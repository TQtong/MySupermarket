...
using ApiResponse = MySupermarket.Common.Configurations.ApiResponse;
...
namespace MySupermarket.Modules.ModuleName.Service
{
    ...
    public class BaseService<TEntity> : IBaseService<TEntity> where TEntity : class
    {
        ...
        public async Task<ApiResponse<PagedList<TEntity>>> GetAllAsync(MySupermarket.Common.Parameter.QueryParameter parameter)
        {
            BaseRequest request = new BaseRequest();
